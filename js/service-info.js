...
(function () {
  ...
  const SERVICE_INFO = {
    ...
    'ffIos': {
      ...
      emoji: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="2" width="10" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>',
      color: '#ffffff',
    ...
    'truecaller': {
      ...
      emoji: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#5d5d59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',
      color: '#858580',
      ...
      note_bn: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#5d5d59" stroke-width="2.2" stroke-linecap="round" style="display:inline;vertical-align:middle;margin-right:4px;"><rect x="7" y="2" width="10" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg> Bangladesh-এ Truecaller সবচেয়ে জনপ্রিয় caller ID app।',
      note_en: 'Most popular caller ID app in Bangladesh.',
    },

    'imo': {
      name: 'imo Premium',
      emoji: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#858580" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',
      color: '#858580',
    ...
    'vpn': {
      name: 'Premium VPN',
      emoji: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',
      color: '#ffffff',
    ...
    'antivirus': {
      ...
      emoji: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>',
      color: '#ffffff',
      ...
      note_bn: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.2" stroke-linecap="round" style="display:inline;vertical-align:middle;margin-right:4px;"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> একটি antivirus ছাড়া আপনার device সবসময় ঝুঁকিতে থাকে।',
    ...
    'adsremove': {
      ...
      note_bn: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.2" stroke-linecap="round" style="display:inline;vertical-align:middle;margin-right:4px;"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg> মাত্র ৳749-এ lifetime ad-free অভিজ্ঞতা!',
    ...
    'windows': {
      ...
      note_bn: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.2" stroke-linecap="round" style="display:inline;vertical-align:middle;margin-right:4px;"><polyline points="20 6 9 17 4 12"/></svg> Original license — pirate Windows-এর ঝামেলা থেকে মুক্তি পান।',
  ...
  function createModal() {
    ...
    modal.innerHTML = `
      <div id="svcInfoModalBox" style="
        ...
        box-shadow:0 32px 80px rgba(0,0,0,0.7),0 0 60px rgba(255, 255, 255,0.06);
        position:relative;overflow-y:auto;overflow-x:hidden;max-height:88vh;
        display:flex;flex-direction:column;
      ">
        <!-- gradient top bar -->
        <div id="svcInfoModalBar" style="height:4px;background:#ffffff;"></div>
        ...
        <div style="padding:28px 28px 32px;" id="svcInfoContent">
          ...
          <div style="display:flex;align-items:flex-start;gap:16px;margin-bottom:20px;">
            ...
            <div>
              ...
              <h2 id="svcInfoModalTitle" style="font-size:clamp(1.2rem,4vw,1.55rem);color:#f5f5f5;font-weight:900;margin:0 0 4px;line-height:1.3;font-family:var(--font-display,sans-serif);"></h2>
              <p id="svcInfoTagline" style="color:#9b9b96;font-size:.88rem;line-height:1.5;margin:0;"></p>
            </div>
          </div>

          <!-- divider -->
          <div style="height:1px;background:rgba(255, 255, 255,0.12);margin:0 0 20px;"></div>

          <!-- What is it -->
          <div style="margin-bottom:20px;">
            <div style="font-size:.72rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase;color:#ffffff;margin-bottom:10px;">
              এটা কী? / What is it?
            </div>
            <p id="svcInfoWhatBn" style="color:#dcdcd8;font-size:.91rem;line-height:1.75;margin:0 0 8px;"></p>
            <p id="svcInfoWhatEn" style="color:#9b9b96;font-size:.84rem;line-height:1.7;margin:0;font-style:italic;"></p>
          </div>

          <!-- Features -->
          <div style="margin-bottom:20px;">
            <div style="font-size:.72rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase;color:#ffffff;margin-bottom:12px;">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="#ffffff" style="vertical-align:middle;margin-right:4px;"><path d="M12 2l2.4 7.2H22l-6 4.8 2.4 7.2L12 16.4 5.6 21.2 8 14 2 9.2h7.6z"/></svg> Premium Features
            </div>
          ...
          <div id="svcInfoNoteWrap" style="margin-bottom:24px;">
            <div id="svcInfoNote" style="
              ...
              color:#c4c4c0;font-size:.84rem;line-height:1.65;font-weight:600;
            "></div>
          </div>
          ...
          <button id="svcInfoCTA" type="button" style="
            ...
            background:#ffffff;
            color:#080808;font-weight:900;font-size:.95rem;cursor:pointer;
        ...
        <!-- close button: pinned to the BOTTOM of the sheet, inside thumb reach -->
        <button id="svcInfoModalClose" type="button" aria-label="Close" style="
          position:sticky;bottom:16px;z-index:40;align-self:center;flex:0 0 auto;
          margin:0 auto -6px;width:56px;height:56px;border-radius:50%;border:0;
          background:#f2f2ef;color:#0c0c0c;cursor:pointer;
          box-shadow:0 10px 30px rgba(0,0,0,.7),0 0 0 6px rgba(12,12,12,.85);
          display:flex;align-items:center;justify-content:center;transition:all 0.2s;
        " onmouseover="this.style.background='#ffffff'" onmouseout="this.style.background='#f2f2ef'">
  ...
  function openModal(key, ctaCallback) {
    ...
    /* Fill content */
    document.getElementById('svcInfoEmoji').innerHTML = data.emoji || '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>';
    ...
    badge.style.background = (data.color || '#ffffff') + '22';
    badge.style.border = '1px solid ' + (data.color || '#ffffff') + '44';
    badge.style.color = data.color || '#ffffff';

    /* Top bar color */
    document.getElementById('svcInfoModalBar').style.background =
      `linear-gradient(90deg, ${data.color || '#ffffff'}, #ffffff)`;
    ...
    ul.innerHTML = (data.features || []).map(f => `
      ...
      ">
        <div style="color:${data.color || '#ffffff'};margin-top:1px;">
        ...
        <div>
          <div style="color:#ededec;font-size:.88rem;font-weight:700;line-height:1.4;">${f.bn}</div>
          <div style="color:#8b8b87;font-size:.78rem;margin-top:2px;line-height:1.35;">${f.en}</div>
        </div>
      </li>
    `).join('');
    ...
    if (data.note_bn) {
      noteEl.innerHTML = `<span style="display:block;margin-bottom:4px;">${data.note_bn}</span>
        <span style="color:#8b8b87;font-size:.8rem;font-style:italic;">${data.note_en || ''}</span>`;
  ...
  style.textContent = `
    ...
    .svc-info-btn {
      ...
      color:#b3b3b0;font-size:.78rem;font-weight:800;cursor:pointer;
    ...
    .svc-info-btn:hover {
      ...
      color:#d9d9d7;transform:translateY(-1px);
    }
