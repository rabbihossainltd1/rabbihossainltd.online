  ...
  function injectCheckoutPanel() {
    ...
    panel.innerHTML = `
      <div class="service-checkout-box">
        ...
        <p class="service-pay-note">Instant Pay করলে payment page open হবে। Rate: $1 / ৳125. Visa/Mastercard price fixed; custom price unavailable.</p>
      </div>
    `;
  ...
  function validateBasicDetails() {
    ...
    if (activeFieldsType === 'ff') {
      ...
      if (!selectedPackage.dataset.productId) {
        showStatus('এই package-এর auto top-up product ID missing. Admin manual process করবে।', 'error');
        return false;
      }
    }
