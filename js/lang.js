/* ================================================================
   lang.js — Bangla / English language switcher
   Usage: included in every page's <head> or before </body>
   Reads localStorage('siteLang') and applies translations via
   data-en / data-bn attributes + class="i18n".
   ================================================================ */
...
(function () {
  ...
  const BN = {
    ...
    'Trusted by 500+ customers · 4.9★ rating':
      '৫০০+ গ্রাহকের বিশ্বাস · ৪.৯★ রেটিং',
  };
  ...
  function applyLang(lang) {
    if (lang === 'bn') {
      ...
      // Add Bangla font link if not already present
  ...
  // ── Translate dynamic content (called after wallet.js renders) ─
  window.rabbiLang = {
    current: currentLang,
  ...
  // Re-apply after dynamic content loads (auth, wallet)
