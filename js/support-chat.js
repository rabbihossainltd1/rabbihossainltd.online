/* ============================================================
   RabbiHossainLTD — Support Chat Widget  v4.0
   Fixes:
   - Auto-reply fires ONLY after user first sends a message
   - Payment: guide only, no numbers, + Binance Pay added
   - Topup: game-only guide, no panel mention
   - Agent form: fixed Firebase write + guest fallback
   - Solved state: input locked, "New Chat" button shown
   ============================================================ */
...
(function () {
  ...
  // botState: 'wait_first_msg' | 'greeted' | 'menu' | 'answering' | 'agent_form' | 'agent_waiting' | 'live' | 'solved'
  ...
  function openChat(){
    ...
    // intentionally NO auto-start — user must type first
  }
  function closeChat(){
