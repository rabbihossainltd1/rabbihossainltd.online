...
function statusClass(status) {
  ...
  if (["approved", "accepted", "confirmed", "completed", "paid_credit_pending_review", "paid_instant_pending_review"].includes(value)) return value;
...
function getFreeFireUid(data) {
  ...
  return details.ff_uid || details.free_fire_uid || details.uid || "";
}
