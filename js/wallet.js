...
window.loadUserDashboard = function () {
  onAuthStateChanged(auth, async (user) => {
    ...
    // Profile page stays lightweight. Full order history is available from My Orders.
    const paymentPanel = document.querySelector('[data-dashboard-panel="payments"]');
    const orderPanel = document.querySelector('[data-dashboard-panel="orders"]');
