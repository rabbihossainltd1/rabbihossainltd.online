  ...
  if (!document.getElementById('reviewSystemCSS')) {
    ...
    s.textContent = `
      ...
      .rv-box {
        ...
        background: linear-gradient(180deg,rgba(255, 255, 255,.07) 0%,rgba(2,8,18,1) 100%);
      ...
      .rv-close {
        ...
        color: #aaaaaa; cursor: pointer; font-size: 1.1rem;
        display: flex; align-items: center; justify-content: center; transition: all .2s;
      }
      .rv-close:hover { color: #ffffff; border-color: rgba(255, 255, 255,.3); }

      .rv-title {
        font-family: var(--font-display,'DM Sans',sans-serif);
        font-size: 1.15rem; font-weight: 800; color: #f7f7f4;
        margin: 0 0 4px; text-align: center;
      }
      .rv-sub {
        font-size: .83rem; color: #8f8f8a; text-align: center;
      ...
      /* ── Input ── */
      .rv-label {
        font-size: .78rem; font-weight: 700; color: #aaaaaa;
        display: block; margin-bottom: 6px; letter-spacing: .04em; text-transform: uppercase;
      }
      .rv-textarea {
        width: 100%; padding: 12px 14px; border-radius: 12px;
        background: rgba(255,255,255,.04); border: 1.5px solid rgba(255,255,255,.1);
        color: #f7f7f4; font-size: .9rem; font-family: inherit;
        outline: none; resize: none; line-height: 1.6; transition: border-color .2s, box-shadow .2s;
        box-sizing: border-box; min-height: 100px;
      }
      .rv-textarea:focus { border-color: rgba(255, 255, 255,.45); box-shadow: 0 0 0 3px rgba(255, 255, 255,.08); }
      .rv-textarea::placeholder { color: #70706d; }

      .rv-char { text-align: right; font-size: .72rem; color: #585855; margin-top: 4px; margin-bottom: 18px; }

      .rv-submit {
        width: 100%; padding: 13px; border: none; border-radius: 14px;
        background: #ffffff;
        color: #080808; font-weight: 900; font-size: .95rem;
      ...
      .rvv-box {
        ...
        background: rgba(6,12,22,1); border: 1px solid rgba(255, 255, 255,.15);
      ...
      .rvv-title { font-size: 1.05rem; font-weight: 800; color: #f7f7f4; }
      .rvv-avg {
      ...
      .rvv-avg-count { font-size: .75rem; color: #8f8f8a; }
      ...
      .rv-card-name { font-weight: 800; font-size: .88rem; color: #e1e1e0; }
      .rv-card-service { font-size: .72rem; color: #71716d; font-weight: 600; }
      .rv-card-date { font-size: .72rem; color: #585855; }
      ...
      .rv-card-text { font-size: .86rem; color: #b1b1ae; line-height: 1.65; }

      .rvv-empty { text-align: center; padding: 40px 0; color: #70706d; font-size: .88rem; }
