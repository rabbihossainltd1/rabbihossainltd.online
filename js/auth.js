...
(function () {
  ...
  function createProfileMenu(auth) {
    ...
    menu.innerHTML = `
      ...
      <div class="profile-balance compact-menu-balance"><span>Balance</span><strong id="profileMenuBalance">$0 / ৳0</strong><a href="add-credit.html" class="menu-balance-plus" aria-label="Add Credit">${iconCredit()}</a></div>
