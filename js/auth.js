...
(function () {
  ...
  function createProfileMenu(auth) {
    ...
    menu.innerHTML = `
      ...
      <div class="profile-balance"><span>Balance</span><strong id="profileMenuBalance">$0 / ৳0</strong></div>
      ...
      <a class="nav-user-menu-btn" href="add-credit.html">${iconCredit()} <span>Add Credit</span></a>
