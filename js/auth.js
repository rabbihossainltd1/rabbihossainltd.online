...
(function () {
  ...
  // Single source of truth: /js/firebase-config.js
  ...
  function injectAuthCSS() {
    ...
    style.textContent = `
      ...
      .auth-icon { width:56px;height:56px;background:rgba(255, 255, 255,0.08);border:1px solid rgba(255, 255, 255,0.2);border-radius:14px;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;color:var(--accent,#ffffff); }
      .auth-title { font-family:var(--font-display,'DM Sans',sans-serif);font-size:1.2rem;font-weight:700;color:#f7f7f4;text-align:center;margin-bottom:8px; }
      .auth-sub { font-size:0.84rem;color:#aaaaaa;text-align:center;line-height:1.6;margin-bottom:22px; }
      ...
      .auth-divider { display:flex;align-items:center;gap:12px;margin:16px 0;color:#70706d;font-size:0.78rem; }
      ...
      .auth-toggle-btn { width:100%;padding:8px;background:none;border:none;color:#aaaaaa;font-size:0.82rem;cursor:pointer;text-align:center; }
      .auth-toggle-btn strong { color:var(--accent,#ffffff); }
      .auth-note { text-align:center;font-size:0.74rem;color:#70706d;margin-top:14px;display:flex;align-items:center;justify-content:center;gap:6px; }
      ...
      #navLoginBtn { padding:7px 16px;background:transparent;border:1px solid rgba(255, 255, 255,0.3);border-radius:50px;color:var(--accent,#ffffff);font-size:0.78rem;font-weight:600;cursor:pointer;font-family:var(--font-display,'DM Sans',sans-serif);transition:all 0.2s; }
      #navLoginBtn:hover { background:rgba(255, 255, 255,0.08);border-color:rgba(255, 255, 255,0.5); }
      #navUserAvatar { display:none;width:34px;height:34px;border-radius:50%;background:#ffffff;border:2px solid rgba(255, 255, 255,0.35);overflow:hidden;align-items:center;justify-content:center;color:#080808;font-size:0.8rem;font-weight:800;box-shadow:0 0 18px rgba(255, 255, 255,0.18); }
      #navUserAvatar img { width:100%;height:100%;object-fit:cover;display:none; }
      #navUserInitial { display:block; }
      .nav-user-menu { position:absolute;top:48px;right:0;background:rgba(8,14,22,0.96);border:1px solid rgba(255, 255, 255,0.18);border-radius:18px;padding:14px;min-width:280px;max-width:calc(100vw - 24px);box-shadow:0 24px 70px rgba(0,0,0,0.65);z-index:2500;display:none;backdrop-filter:blur(18px); }
      ...
      .profile-photo-wrap { position:relative;width:54px;height:54px;border-radius:50%;overflow:hidden;background:#ffffff;display:flex;align-items:center;justify-content:center;color:#080808;font-weight:900;flex-shrink:0; }
      .profile-photo-wrap img { width:100%;height:100%;object-fit:cover;display:none; }
      .profile-name { color:#f7f7f4;font-weight:800;font-size:.92rem;line-height:1.25;word-break:break-word; }
      .profile-email { color:#aaaaaa;font-size:.76rem;margin-top:3px;word-break:break-word; }
      .profile-balance { background:rgba(255, 255, 255,0.08);border:1px solid rgba(255, 255, 255,0.20);border-radius:14px;padding:12px;margin:10px 0;color:#e9e9e8;display:flex;justify-content:space-between;gap:10px;align-items:center;font-size:.86rem; }
      .profile-balance strong { color:#ffffff;font-size:1rem; }
      .profile-upload { display:grid;grid-template-columns:1fr;gap:8px;margin:10px 0; }
      .nav-user-menu-btn { width:100%;padding:10px 12px;background:none;border:none;color:#f7f7f4;font-size:0.86rem;cursor:pointer;text-align:left;border-radius:10px;transition:background 0.2s;display:flex;align-items:center;justify-content:flex-start;gap:8px;text-decoration:none;font-family:inherit; }
      .profile-btn-icon { width:18px;height:18px;flex:0 0 18px;color:var(--accent,#ffffff); }
      .nav-user-menu-btn:hover { background:rgba(255,255,255,0.06); }
      .nav-user-menu-btn.primary { background:linear-gradient(135deg,rgba(255, 255, 255,.14),rgba(255, 255, 255,.10));border:1px solid rgba(255, 255, 255,.14); }
      .nav-user-menu-btn.danger { color:#ff9d9d; }
      .nav-user-menu-btn[hidden] { display:none !important; }
      .profile-mini-note { color:#aaaaaa;font-size:.72rem;line-height:1.45;margin:2px 0 8px; }
      ...
      .profile-settings-box { width:100%;max-width:460px;max-height:92vh;overflow:auto;background:rgba(8,14,22,.98);border:1px solid rgba(255, 255, 255,.18);border-radius:22px;padding:22px;box-shadow:0 30px 90px rgba(0,0,0,.72); }
      ...
      .settings-head h3 { color:#f7f7f4;font-size:1.05rem;margin:0;font-family:var(--font-display,'DM Sans',sans-serif); }
      .settings-head p { color:#aaaaaa;font-size:.78rem;line-height:1.5;margin:4px 0 0; }
      .settings-close { width:34px;height:34px;border-radius:10px;border:1px solid rgba(255,255,255,.10);background:rgba(255,255,255,.05);color:#b7b7b4;cursor:pointer;font-size:1.2rem;line-height:1; }
      ...
      .settings-section-title { display:flex;align-items:center;gap:8px;color:#f7f7f4;font-size:.9rem;font-weight:800;margin-bottom:12px; }
      .settings-label { display:block;color:#bfbfbc;font-size:.76rem;font-weight:700;margin:10px 0 6px; }
      .settings-input { width:100%;padding:11px 13px;border-radius:11px;border:1px solid rgba(255,255,255,.10);background:rgba(0,0,0,.25);color:#f7f7f4;outline:none;font-family:inherit;font-size:.88rem; }
      .settings-input:focus { border-color:rgba(255, 255, 255,.45); }
      .settings-actions { display:grid;grid-template-columns:1fr;gap:8px;margin-top:12px; }
      .settings-btn { width:100%;padding:11px 12px;border-radius:12px;border:1px solid rgba(255, 255, 255,.18);background:linear-gradient(135deg,rgba(255, 255, 255,.14),rgba(255, 255, 255,.10));color:#f7f7f4;font-weight:800;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;font-family:inherit; }
      .settings-btn.secondary { background:rgba(255,255,255,.055);border-color:rgba(255,255,255,.10);color:#cececc; }
      ...
      .settings-message.success { display:block;background:rgba(255, 255, 255,.08);border:1px solid rgba(255, 255, 255,.20);color:#e0e0df; }
      ...
      .settings-history-title { color:#f7f7f4;font-weight:800;font-size:.84rem;line-height:1.35;word-break:break-word; }
      .settings-history-amount { color:#ffffff;font-weight:900;font-size:.82rem;white-space:nowrap; }
      .settings-history-meta { color:#aaaaaa;font-size:.74rem;line-height:1.45;margin-top:3px;word-break:break-word; }
      .settings-history-status { display:inline-block;margin-top:7px;padding:4px 8px;border-radius:999px;background:rgba(255, 255, 255,.10);border:1px solid rgba(255, 255, 255,.16);color:#d4d4d2;font-size:.68rem;font-weight:800;text-transform:uppercase; }
      .settings-history-empty { color:#aaaaaa;font-size:.8rem;line-height:1.55;padding:10px 0; }
      .rabbi-bottom-nav { position:fixed; left:14px; right:14px; bottom:12px; z-index:2400; display:grid; grid-template-columns:repeat(5,1fr); gap:8px; max-width:620px; margin:0 auto; padding:8px; border-radius:24px; background:rgba(5,10,16,.92); border:1px solid rgba(255, 255, 255,.18); box-shadow:0 18px 55px rgba(0,0,0,.55),0 0 24px rgba(255, 255, 255,.08); backdrop-filter:blur(18px); }
      .rabbi-bottom-nav a { display:flex; flex-direction:column; align-items:center; justify-content:center; gap:4px; min-height:54px; border-radius:18px; color:#aaaaaa; text-decoration:none; font-size:.68rem; font-weight:800; letter-spacing:.01em; transition:.2s ease; }
      .rabbi-bottom-nav a svg { width:20px; height:20px; stroke-width:1.8; }
      .rabbi-bottom-nav a.active, .rabbi-bottom-nav a:hover { color:#080808; background:#ffffff; box-shadow:0 8px 24px rgba(255, 255, 255,.20); }
      .customer-service-nav a { border:1px solid rgba(255, 255, 255,.16); border-radius:999px; padding:10px 14px!important; background:rgba(255, 255, 255,.06); }
      body.has-bottom-nav { padding-bottom:calc(86px + env(safe-area-inset-bottom,0px)) !important; }
      body.has-bottom-nav main, body.has-bottom-nav .wallet-page, body.has-bottom-nav .dashboard-page { padding-bottom:0 !important; }
      ...
      .nav-user-menu .menu-balance-plus{
        ...
        box-shadow:0 12px 26px rgba(255, 255, 255,.18)!important;
        overflow:hidden!important;
      }
      ...
      [data-theme="light"] .auth-modal-box { background:#fff; border:1px solid rgba(0,0,0,.12); box-shadow:0 24px 70px rgba(0,0,0,.16); }
      [data-theme="light"] .auth-title { color:#161616; }
      [data-theme="light"] .auth-sub, [data-theme="light"] .auth-note, [data-theme="light"] .auth-toggle-btn { color:#6f6f6c; }
      [data-theme="light"] .auth-toggle-btn strong { color:#111; }
      [data-theme="light"] .auth-icon { background:#f0f0ee; border-color:rgba(0,0,0,.12); color:#111; }
      [data-theme="light"] .auth-modal-close { background:#f0f0ee; border-color:rgba(0,0,0,.12); color:#4a4a48; }
      [data-theme="light"] .auth-google-btn { background:#fff; color:#161616; border:1px solid rgba(0,0,0,.16); box-shadow:none; }
      [data-theme="light"] .auth-submit-btn { background:#fff; color:#111; border:1px solid #111; }
      [data-theme="light"] .auth-input { background:#fff; color:#161616; border-color:rgba(0,0,0,.14); }
      [data-theme="light"] .auth-divider::before, [data-theme="light"] .auth-divider::after { background:rgba(0,0,0,.1); }
      [data-theme="light"] #navLoginBtn { background:#fff; color:#111; border:1px solid rgba(0,0,0,.22); }
      [data-theme="light"] #navLoginBtn:hover { background:#111; color:#fff; border-color:#111; }
      [data-theme="light"] .nav-user-menu { background:#fff; border:1px solid rgba(0,0,0,.12); box-shadow:0 24px 70px rgba(0,0,0,.14); }
      [data-theme="light"] .profile-name, [data-theme="light"] .nav-user-menu-btn { color:#161616; }
      [data-theme="light"] .profile-email, [data-theme="light"] .profile-mini-note { color:#6f6f6c; }
      [data-theme="light"] .profile-balance { background:#f5f5f2; border-color:rgba(0,0,0,.1); color:#161616; }
      [data-theme="light"] .profile-balance strong, [data-theme="light"] .nav-user-menu .profile-balance-info strong, [data-theme="light"] .nav-user-menu #profileMenuBalance { color:#161616 !important; }
      [data-theme="light"] .nav-user-menu .profile-balance-info span { color:#6f6f6c !important; }
      [data-theme="light"] .nav-user-menu-btn:hover { background:rgba(0,0,0,.05); }
      [data-theme="light"] .nav-user-menu-btn.primary { background:#111; color:#fff; border-color:#111; }
      [data-theme="light"] .profile-btn-icon { color:#2a2a2a; }
      [data-theme="light"] .nav-user-menu-btn.primary .profile-btn-icon { color:#fff; }
      [data-theme="light"] .profile-settings-box { background:#fff; border-color:rgba(0,0,0,.12); }
      [data-theme="light"] .settings-head h3, [data-theme="light"] .settings-section-title, [data-theme="light"] .profile-settings-title { color:#161616; }
      [data-theme="light"] .settings-head p, [data-theme="light"] .profile-settings-sub { color:#6f6f6c; }
      [data-theme="light"] .settings-section { background:#fafafa; border-color:rgba(0,0,0,.1); }
      [data-theme="light"] .settings-input { background:#fff; color:#161616; border-color:rgba(0,0,0,.14); }
      [data-theme="light"] .settings-btn { background:#111; color:#fff; border-color:#111; }
      [data-theme="light"] .settings-btn.secondary { background:#fff; color:#2a2a2a; border-color:rgba(0,0,0,.16); }
      [data-theme="light"] .rabbi-bottom-nav { background:rgba(255,255,255,.94); border:1px solid rgba(0,0,0,.12); box-shadow:0 16px 40px rgba(0,0,0,.12); }
      [data-theme="light"] .rabbi-bottom-nav a { color:#6f6f6c; }
      [data-theme="light"] .rabbi-bottom-nav a.active, [data-theme="light"] .rabbi-bottom-nav a:hover { background:#111; color:#fff; box-shadow:none; }
    `;
  ...
  async function loadFirebaseModules() {
    ...
    // Reuse the shared instance from firebase-core.js — it is the one created
    // with persistentLocalCache. Calling getFirestore(app) here would race it
    // and, if this ran first, silently give everyone a memory-only cache
    // (which is exactly what made the balance wait on the network).
    let db;
    try {
      const core = await import('/js/firebase-core.js');
      db = core.db;
    } catch (e) {
  ...
  function cachedAuth() {
    try { return JSON.parse(localStorage.getItem('rh_user_cache') || 'null') || {}; }
    catch (e) { return {}; }
  }
  ...
  function updateProfileMenu(user, data) {
    ...
    if (nameEl) {
      const badge = nameEl.querySelector('.user-verify-badge');
      nameEl.textContent = data?.name || user?.displayName || cache.displayName || 'User';
      if (badge) nameEl.appendChild(badge);
    }
    if (emailEl) emailEl.textContent = data?.email || user?.email || cache.email || '';

    // Balance: only paint a real Firestore number. Until it arrives, keep the
    // cached string — writing dollar(0) here is what made the balance visibly
    // flash "$0 / ৳0" for a second on every page load.
    if (balanceEl) {
      const hasLive = data && data.credit !== undefined && data.credit !== null;
      if (hasLive) {
        balanceEl.dataset.rhLive = '1';
        balanceEl.textContent = dollar(data.credit);
      } else if (!balanceEl.dataset.rhLive && cache.balance) {
        balanceEl.textContent = cache.balance;
      }
    }
  ...
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M7 12.5l3.5 3.5 6.5-7" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <a class="nav-user-menu-btn primary" href="/dashboard/">${iconDashboard()} <span>Dashboard</span></a>
      ...
      <a class="nav-user-menu-btn" href="mailto:support@rabbihossainltd.online">${iconSupport()} <span>Email Support</span></a>
      <a class="nav-user-menu-btn" id="navAdminBtn" href="/admin/" hidden>${iconShield()} <span>Admin Panel</span></a>
    ...
    // boot-auth.js holds the cached values; let it fill the freshly built menu
    // on this same frame so the balance is never blank/zero while Firestore
    // is still in flight.
    ...
    cm.innerHTML = `
      <div style="background:rgba(6,12,22,1);border:1px solid rgba(255, 255, 255,.2);border-radius:22px;padding:24px;width:min(400px,100%);display:flex;flex-direction:column;gap:16px;">
        ...
        <div style="display:flex;align-items:center;gap:10px;">
          ...
          <input type="range" id="cropZoom" min="100" max="300" value="100" style="flex:1;accent-color:#ffffff;">
        </div>
        <div style="display:flex;gap:10px;">
          <button id="cropCancel" type="button" style="flex:1;padding:11px;border-radius:12px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);color:#b1b1ae;font-weight:700;cursor:pointer;font-family:inherit;">Cancel</button>
          <button id="cropApply" type="button" style="flex:2;padding:11px;border-radius:12px;border:none;background:#ffffff;color:#080808;font-weight:900;cursor:pointer;font-family:inherit;">Apply & Preview</button>
        </div>
      </div>`;
  ...
  function createProfileSettingsModal() {
    ...
    if (saveLangBtn) {
      saveLangBtn.addEventListener('click', function() {
        ...
        setSettingsMessage('success', selected.value === 'bn' ? 'Language saved. Reloading...' : 'Language saved. Reloading...');
  ...
  function openProfileSettings(focusTarget) {
    // Settings now live on a dedicated page instead of a popup.
    const q = focusTarget ? ('?focus=' + encodeURIComponent(focusTarget)) : '';
    window.location.href = '/settings/' + q;
  }

  // Dedicated settings page bootstrap — fills the form and wires every control.
  let _settingsPageWired = false;
  let _settingsPageFilled = false;
  function initSettingsPage() {
    ...
    function fillIfReady() {
      ...
      if (!_settingsPageFilled) {
        _settingsPageFilled = true;
        fillSettingsForm();
      }
    }
    ...
    fillIfReady();
    window.addEventListener('rabbi:userData', fillIfReady);
    window.addEventListener('rabbi:loggedin', fillIfReady);
    let tries = 60;
    (function settle() {
      if (currentUser) { fillIfReady(); return; }
  ...
  displayName: fullName
      ...
      if (dbApi) {
        ...
        const db = (dbApi && dbApi.db) || getFirestore(getApp());
        await updateDoc(doc(db, 'users', currentUser.uid), {
          name: fullName,
          photoURL: photoURL || '',
          updatedAt: serverTimestamp()
  ...
  function injectBottomNavigation() {
    ...
    const items = [
      { href: '/', key: 'home', label: 'Home', active: page === '/' || page === '' },
      { href: '/add-credit/', key: 'credit', label: 'Add Credit', active: page === '/add-credit/' },
      { href: '/cart/', key: 'cart', label: 'Cart', active: page === '/cart/' },
      { href: '/dashboard/?tab=orders', key: 'orders', label: 'My Orders', active: page === '/dashboard/' && qs.get('tab') === 'orders' },
      { href: '/dashboard/', key: 'profile', label: 'Profile', active: page === '/dashboard/' && qs.get('tab') !== 'orders' }
    ];
  ...
  async function bootstrap() {
    ...
    function refreshAfterLoginOnce() {
      ...
      setTimeout(() => {
        if (back && back !== here) window.location.replace(back);
    ...
    window.rabbiAuth = {
      ...
      getCredit: () => {
        if (currentUserData && typeof currentUserData.credit === 'number') return Number(currentUserData.credit);
        // Fall back to the cached balance so payments never see a "0" while
        // Firestore is still loading (zero-latency balance).
        try {
          const c = JSON.parse(localStorage.getItem('rh_user_cache') || 'null');
          if (c && typeof c.credit_raw === 'number') return Number(c.credit_raw);
        } catch (e) {}
        return 0;
      },
