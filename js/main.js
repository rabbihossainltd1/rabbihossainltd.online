...
// Clean URLs are folders (/services/), so .pop() yields '' for every page and
// every link — which lit them all up. Compare normalised paths instead.
...
document.querySelectorAll('.nav-links a').forEach(link => {
  ...
  link.classList.toggle('active', normalisePath(href) === currentPath);
});
...
'<div class="fs-body">Thank you for reaching out. I\'ve received your message and will get back to you within <strong style="color:#ababa8;">24–48 hours</strong>.</div>' +
